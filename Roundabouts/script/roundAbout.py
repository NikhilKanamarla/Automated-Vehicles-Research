...
##############################################################
#For path index 17
#initial x and y positions of each vehicle?
...
t30 = Thread(target = zumoThread, args = (1, "zumoTest1", rate, copy.deepcopy(GetDefaultPath(17))))
t30.start()
...
t4 = Thread(target = zumoThread, args = (22, "zumoTest22", 0.05, copy.deepcopy(GetDefaultPath(21))))
t4.start()
