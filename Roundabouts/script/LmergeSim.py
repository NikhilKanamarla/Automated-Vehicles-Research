# this is base line senario of CAVs where the secondary road CAV yields to the main road CAV
#!/usr/bin/env python
...
def zumoThread(index, frameName, controlRate, path):
    ...
    cur_t = time.time() # initial time to
    #print "current time is ", cur_t
    dx = 0.0
    dy = 0.0
