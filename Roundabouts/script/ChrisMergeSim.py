...
t1 = Thread(target = zumoThread, args = (14, "zumoTest14", 0.05, copy.deepcopy(Path.GetDefaultPath(8))))
t1.start()
t1 = Thread(target = zumoThread, args = (31, "zumoTest31", 0.05, copy.deepcopy(Path.GetDefaultPath(8))))
t1.start()
t3 = Thread(target = zumoThread, args = (33, "zumoTest33", 0.05, copy.deepcopy(Path.GetDefaultPath(8))))
t3.start()
...
t11 = Thread(target = zumoThread, args = (28, "zumoTest28", 0.05, copy.deepcopy(Path.GetDefaultPath(0))))
t11.start()
t12 = Thread(target = zumoThread, args = (21, "zumoTest21", 0.05, copy.deepcopy(Path.GetDefaultPath(0))))
t12.start()
#t13 = Thread(target = zumoThread, args = (19, "zumoTest19", 0.05, copy.deepcopy(Path.GetDefaultPath(0))))
#t13.start()
