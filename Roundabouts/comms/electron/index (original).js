...
//    });
  ...
  //sent velocities
    ...
    if (velocities.substr(0,2) == '31'){
      rightVelocity31 = velocities.substring(velocities.indexOf(':')+1, velocities.indexOf(','));
      leftVelocity31 = velocities.substring(velocities.indexOf(',')+1, velocities.indexOf(';'));
      console.log('Robot31:'+rightVelocity31+","+leftVelocity31+'recived!!!!!!!!!')
    }     
    if (velocities.substr(0,2) == '32'){
      rightVelocity32 = velocities.substring(velocities.indexOf(':')+1, velocities.indexOf(','));
      leftVelocity32 = velocities.substring(velocities.indexOf(',')+1, velocities.indexOf(';'));
      console.log('Robot32:'+rightVelocity32+","+leftVelocity32+'recived!!!!!!!!!')
    }     
    if (velocities.substr(0,2) == '33'){
      rightVelocity33 = velocities.substring(velocities.indexOf(':')+1, velocities.indexOf(','));
      leftVelocity33 = velocities.substring(velocities.indexOf(',')+1, velocities.indexOf(';'));
      //console.log('Robot20:'+rightVelocity20+","+leftVelocity20+'recived!!!!!!!!!')
    }     
    if (velocities.substr(0,2) == '34'){
      rightVelocity34 = velocities.substring(velocities.indexOf(':')+1, velocities.indexOf(','));
      leftVelocity34 = velocities.substring(velocities.indexOf(',')+1, velocities.indexOf(';'));
      //console.log('Robot20:'+rightVelocity20+","+leftVelocity20+'recived!!!!!!!!!')
    }     
    if (velocities.substr(0,2) == '35'){
      rightVelocity35 = velocities.substring(velocities.indexOf(':')+1, velocities.indexOf(','));
      leftVelocity35 = velocities.substring(velocities.indexOf(',')+1, velocities.indexOf(';'));
      //console.log('Robot20:'+rightVelocity20+","+leftVelocity20+'recived!!!!!!!!!')
    }
  ...
  //disconnect handler
    var if_connected = setInterval(function(){ 
        ...
        socket.emit('velocity31', leftVelocity31+','+rightVelocity31+';')
        socket.emit('velocity32', leftVelocity32+','+rightVelocity32+';')
        socket.emit('velocity33', leftVelocity33+','+rightVelocity33+';')
        socket.emit('velocity34', leftVelocity34+','+rightVelocity34+';')
        socket.emit('velocity35', leftVelocity35+','+rightVelocity35+';')   
        //count = count + 1;
