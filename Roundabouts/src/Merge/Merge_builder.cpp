...
void MergeBuilder::BuildMerge()
{
    ...
    z3->init_time = time(0);
    z3->entrences.push_back(EntrenceInfo{1.3,0.4,0.36}); //L,S,delta 
    z3->entrences.push_back(EntrenceInfo{1.3,0.4,0.36}); //L,S,delta 
    ...
    z4->init_time = time(0);
    z4->entrences.push_back(EntrenceInfo{0.5,0.3,0.25});//these are for the roundabou
    z4->entrences.push_back(EntrenceInfo{0.5,0.3,0.25});//these are for the roundabout 
    zoneList.push_back(z4);
}