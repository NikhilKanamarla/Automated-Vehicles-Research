...
#path3
	...
	# How to calculate delta value? Delta value is the saftey length so try 0.5
        ...
        res.AppendSegment(173,2.159+0.0716,float('nan'),False,True)#A81
        res.AppendSegment(90,-0.951+0.076,float('nan'),False,True)#S94
        res.segments[len(res.segments)-1].AppendControlBorder(0,4,0,-1.2,float('nan'),True,True) #float nan for y axis 
        res.AppendSegment(198,-2.336+0.076,0.884+0.076,False,False)#A106
        res.segments[len(res.segments)-1].AppendControlBorder(1,4,0,-1.75,float('nan'),True,True)
        res.AppendSegment(197,-2.329-0.076,0.278,True,False)#A105
        res.segments[len(res.segments)-1].AppendControlBorder(2,4,0,-2.3,float('nan'),True,True)
        res.AppendSegment(193,-1.617,-0.091,True,True)#A101
        res.AppendSegment(192,float('nan'),0.35-0.076,True,True)#A100*
        ...
        res.AppendSegment(173,2.159+0.0716,float('nan'),False,True)#A81
        res.AppendSegment(90,-0.951+0.076,float('nan'),False,True)#S94
        res.segments[len(res.segments)-1].AppendControlBorder(0,4,0,-0.2 ,float('nan'),True,True)
        res.AppendSegment(198,-2.336+0.076,0.884+0.076,False,False)#A106
        res.segments[len(res.segments)-1].AppendControlBorder(1,4,0,-1.46,1.22,True,True)
        res.AppendSegment(197,-2.329-0.076,0.278,True,False)#A105
        res.segments[len(res.segments)-1].AppendControlBorder(2,4,0,-2.5,0.66,True,True)
        res.AppendSegment(193,-1.617,-0.091,True,True)#A101
        res.AppendSegment(192,float('nan'),0.35-0.076,True,True)#A100*
        res.AppendSegment(191,-0.872-.076,float('nan'),True,True)#A99*
        res.AppendSegment(91,-0.872+0.16,float('nan'),True,True)#S95
    ...
    # dual dynamic roundabouts lower start  
    elif index == 44:
        res.AppendSegment(90,-0.951+0.076,float('nan'),False,True)#S94
        #res.segments[len(res.segments)-1].AppendControlBorder(2,4,0,0,float('nan'),True,True)
        res.segments[len(res.segments)-1].AppendControlBorder(0,4,0,-1.2,0.7,True,True)
        #note that 4 refers to the control zone 4 object in mergeBuilder
        res.AppendSegment(198,-2.336+0.076,0.884+0.076,False,False)#A106
        res.segments[len(res.segments)-1].AppendControlBorder(1,4,0,-1.75,0.64,True,True)
        res.AppendSegment(197,-2.329-0.076,0.278,True,False)#A105
        res.segments[len(res.segments)-1].AppendControlBorder(2,4,0,-2.3,0.47,True,True)
        res.AppendSegment(193,-1.617,-0.091,True,True)#A101
        res.AppendSegment(192,float('nan'),0.35-0.076,True,True)#A100*
        res.AppendSegment(191,-0.872-.076,float('nan'),True,True)#A99*
        res.AppendSegment(91,-0.872+0.16,float('nan'),True,True)#S95
    ...
    #right western roundabout (control zones need to be the same as the roundabouts) 
        ...
        res.AppendSegment(193,-1.617,-0.091,True,True)#A101
        res.AppendSegment(192,float('nan'),0.35-0.076,True,True)#A100*
        res.segments[len(res.segments)-1].AppendControlBorder(0,4,1,-1.47,0.08,True,True)
    ...
    #right northern roundabout (control zones need to be the same as the roundabouts) 
        ...
        res.segments[len(res.segments)-1].AppendControlBorder(1,4,1,-1.44,0.27,True,True)
        res.segments[len(res.segments)-1].AppendControlBorder(0,4,1,-1.84,0.67,True,True)
        res.AppendSegment(197,-2.329-0.076,0.278,True,False)#A105
        res.segments[len(res.segments)-1].AppendControlBorder(2,4,1,-2.3,0.47,True,True)
        return res
    ...
    #right southern roundabout (control zones need to be the same as the roundabouts) 
        ...
        res.AppendSegment(197,-2.329-0.076,0.278,True,False)#A105
        res.segments[len(res.segments)-1].AppendControlBorder(2,4,1,-2.3,float('nan'),True,True)
        res.AppendSegment(193,-1.617,-0.091,True,True)#A101
        res.AppendSegment(192,float('nan'),0.35-0.076,True,True)#A100*
        res.segments[len(res.segments)-1].AppendControlBorder(1,4,1,-1.2,float('nan'),True,True)
        res.AppendSegment(200,-2.07,float('nan'),False,False)#A108
        res.segments[len(res.segments)-1].AppendControlBorder(0,4,1,-1.75,float('nan'),True,True)
        return res
    ...
    # dual dynamic roundabouts lower start (control zones need to be the same as the roundabouts) 
        ...
        res.AppendSegment(197,-2.329-0.076,0.278,True,False)#A105
         # potenial issue is different ending of merging zones and float nan of roundabout
        res.AppendSegment(193,-1.617,-0.091,True,True)#A101
        res.AppendSegment(192,float('nan'),0.35-0.076,True,True)#A100*
        res.AppendSegment(191,-0.872-.076,float('nan'),True,True)#A99*
        res.AppendSegment(91,-0.872+0.16,float('nan'),True,True)#S95
